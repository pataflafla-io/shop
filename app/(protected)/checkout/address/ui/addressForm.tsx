...
export const AddressForm = ({ countries, userStoredAddress }: Props) => {
    ...
    // defaultValues lees desde la bd para popular los campos.
    //
    // ¿Por qué hacer ésto?
    // Caso de uso 1: 
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-2 sm:gap-5 sm:grid-cols-2">
            ...
            <div className="flex flex-col mb-2" >
                ...
                <input
                    type="text"
                    className={clsx("border border-2 border-transparent p-2 rounded-md bg-gray-200", { "border-brand-burnt-peach": errors.firstName })}
            ...
            <div className="flex flex-col mb-2">
                ...
                <input
                    type="text"
                    className={clsx("border border-2 border-transparent p-2 rounded-md bg-gray-200", { "border-brand-burnt-peach": errors.lastName })}
            ...
            <div className="flex flex-col mb-2">
                ...
                <input
                    type="text"
                    className={clsx("border border-2 border-transparent p-2 rounded-md bg-gray-200", { "border-brand-burnt-peach": errors.address })}
            ...
            <div className="flex flex-col mb-2">
                ...
                <input
                    type="text"
                    className={clsx("border border-2 border-transparent p-2 rounded-md bg-gray-200", { "border-brand-burnt-peach": errors.zipCode })}
            ...
            <div className="flex flex-col mb-2">
                ...
                <input
                    type="text"
                    className={clsx("border border-2 border-transparent p-2 rounded-md bg-gray-200", { "border-brand-burnt-peach": errors.city })}
            ...
            <div className="flex flex-col mb-2">
                <span>Country</span>
                <select
                    className={clsx("border border-2 border-transparent p-2 rounded-md bg-gray-200", { "border-brand-burnt-peach": errors.country })}
            ...
            <div className="flex flex-col mb-2">
                ...
                <input
                    type="text"
                    className={clsx("border border-2 border-transparent p-2 rounded-md bg-gray-200", { "border-brand-burnt-peach": errors.phone })}
