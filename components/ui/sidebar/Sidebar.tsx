...
export const Sidebar = () => {
    return (
        <div>
            ...
            <div className="fade-in fixed z-10 top-0 left-0 w-full h-screen backdrop-filter backdrop-blur-md" />
            <nav className="fixed z-20 top-0 right-0 p-5 w-100 h-screen bg-white shadow-2xl transition-all duration-300">
                <IoCloseOutline size={50} className="absolute top-5 right-5" onClick={() => console.log('close')} />
